...
I focus on the case of the \textit{sharp} identified set in the sense of MST, which is arguably the most relevant specification.
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.49\textwidth}
      ...
      \caption{Degree $k=2$}\label{fig:simulation_binary_iv_bernstein}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
      \centering
      \includegraphics[width=\textwidth]{../../bld/figures/binary_iv/id_bernstein_11_none_late.png}
      \caption{Degree $k=11$}\label{fig:simulation_binary_iv_bernstein}
  \end{subfigure}
\end{figure}
...
\begin{itemize}
  \item Vary the sub-sampling size
  \item
\end{itemize}
