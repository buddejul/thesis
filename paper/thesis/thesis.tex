...
In most applications, the non-parametric identified set resulting from constant splines will features solutions, i.e. MTR functions, that exhibit jump discontinuities.
...
However, the value function of the linear program, that is the upper or lower bound of the identified set, can still be \textit{non-smoth} and feature kinks.
...
While somewhat arbitrary, I report results for a lower, meaning more restrictive, polynomial of degree $2$ as well as an $11$th order polynomial similar to~\cite{mogstad2018using}.
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.49\textwidth}
      ...
      \caption{Degree $k=3$}\label{fig:id_set_binary_iv_bernstein_k_2}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
      \centering
